...
- [oh-my-claudecode](https://github.com/Yeachan-Heo/oh-my-claudecode) plugin installé (**requis**)
- [oh-my-codex](https://github.com/Yeachan-Heo/oh-my-codex) installé (*optionnel* — pour les fonctionnalités Codex)
