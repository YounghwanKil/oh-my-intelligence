...
- [oh-my-claudecode](https://github.com/Yeachan-Heo/oh-my-claudecode) 플러그인 설치 (**필수**)
- [oh-my-codex](https://github.com/Yeachan-Heo/oh-my-codex) 설치 (*선택* — Codex 기능 사용 시)
...
==========
  ...
  OMX (oh-my-codex):      ✓ v0.11.13  (또는: 미설치 — Claude 폴백 활성)
